...
public class employeeinsert extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("EMPLOYEE INSERTION");
        ...
        jLabel5.setText("POSITION_ID");

        jLabel6.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jLabel6.setText("QUAL_ID");
        ...
        jLabel11.setText("HIRE_DATE");

        jLabel12.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jLabel12.setText("BIRTH_DATE");
...
System.exit(0);        // TODO add your handling code here:
    ...
    int POSITION_ID =Integer.parseInt(jTextField7.getText());
    int QUAL_ID =Integer.parseInt(jTextField8.getText());
    int DEPT_ID =Integer.parseInt(jTextField9.getText());
    ...
    String HIRE_DATE =jTextField13.getText();
    String BIRTH_DATE =jTextField14.getText();
    String PAN_NO=jTextField15.getText();
    
    
    try{
       Class.forName("java.sql.DriverManager");
       Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/hrms","root","");
       String query="insert into employee values ('"+EMPLOYEE_ID+"','"+LAST_NAME+"','"+FIRST_NAME+"','"+POSITION_ID+"','"+QUAL_ID+"','"+DEPT_ID+"','"+SUPERVISOR+"','"+SALARY+"','"+COMMISSION+"','"+HIRE_DATE+"','"+BIRTH_DATE+"','"+PAN_NO+"' );";
